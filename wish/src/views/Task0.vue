<template>
	<div ref='root' class="wish-task">
		<wish-page :ref="'page'+index" v-for="index in 19" :key="index" :index="index" :background='require("../assets/task0/background/" + index + ".jpg")'
		 :items="require('../assets/task0/json/' + index + '.json')" @submit="submitHandler(index)" msg="填写错误" @SendCode="sendCodeHandler(index)">
		</wish-page>
